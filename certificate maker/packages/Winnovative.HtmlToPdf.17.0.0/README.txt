Winnovative HTML to PDF Library for .NET
========================================
...
For .NET Core and .NET Standard applications on Windows you can use the library from Winnovative.HtmlToPdf.NetCore NuGet package.
